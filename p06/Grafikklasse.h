...
class Linie: public GrafikElement {
	...
	public:
		...
		Linie(int XS, int YS, RGB_Pixel C):
			GrafikElement(XS, YS), c(C) {};
...
class Kreis: public GrafikElement {
	...
	public:
		...
		Kreis(int XS, int YS, RGB_Pixel C, int R):
			GrafikElement(XS, YS), c(C), radius(R) {};
...
class Rechteck: public GrafikElement {
	...
	public:
		...
		Rechteck(int XS, int YS, int XE, int YE, RGB_Pixel C):
			GrafikElement(XS, YS), xe(XE), ye(YE), c(C) {};
...
class RechteckGefuellt: public Rechteck {
	...
	public:
		...
		RechteckGefuellt(int XS, int YS, int XE, int YE, RGB_Pixel C, RGB_Pixel F):
			Rechteck(XS, YS, XE, YE, C), f(F) {};
...
class Zeichen: public GrafikElement {
	...
	public:
		...
		Zeichen(int XS, int YS, unsigned char CH, RGB_Pixel FG, RGB_Pixel BG):
			GrafikElement(XS, YS), ch(CH), fg(FG), bg(BG) {};
...
class TextZeile: public GrafikElement {
	...
	public:
		...
		TextZeile(int XS, int YS, string STR, RGB_Pixel FG, RGB_Pixel BG):
			GrafikElement(XS, YS), s(STR), fg(FG), bg(BG) {};
